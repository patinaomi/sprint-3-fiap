...
CREATE TABLE Visitante(id_visit NUMBER(10) GENERATED ALWAYS as IDENTITY START WITH 1 INCREMENT BY 1
                       ...
                       -- foi utilizado timestamp para facilitar a manipulação de dados no Java
                       data_hora_visit TIMESTAMP CONSTRAINT visitante_datahora_nn NOT NULL,
...
CREATE TABLE Plataforma_Login(id_login NUMBER(10) GENERATED ALWAYS as IDENTITY START WITH 1 INCREMENT BY 1
                              ...
                              data_implementacao_login TIMESTAMP CONSTRAINT login_data_nn NOT NULL,
...
CREATE TABLE Questionario(num_quest NUMBER(10) GENERATED ALWAYS as IDENTITY START WITH 1 INCREMENT BY 1
                          ...
                          data_hora_visita_quest TIMESTAMP CONSTRAINT quest_data_hora_visita_nn NOT NULL,
...
CREATE TABLE Leads(id_leads NUMBER(10) GENERATED ALWAYS as IDENTITY START WITH 1 INCREMENT BY 1
                   ...
                   data_hora_login_leads TIMESTAMP CONSTRAINT leads_data_hora_login_nn NOT NULL,
                   -- Inserção da Foreign Key
...
CREATE TABLE Pergunta_Chatbot(id_pergunta_chatbot NUMBER(10),
                              ...
                              data_hora_chatbot TIMESTAMP CONSTRAINT chatbot_data_hora_nn NOT NULL,
...
CREATE TABLE Experiencia_Usuario(id_exp NUMBER(10)GENERATED ALWAYS as IDENTITY START WITH 1 INCREMENT BY 1
                                 ...
                                 data_hora_vis_exp TIMESTAMP CONSTRAINT exp_data_hora_vis_nn NOT NULL,
...
(1, 'patinaomi', 'Ativo', TO_DATE('25/03/2024 11:30:00', 'DD/MM/YYYY HH24:MI:SS'), 'pat@oi.com'); 

INSERT INTO Questionario(visit_id_visit_fk, data_hora_visita_quest, email_quest) VALUES
(1, TO_DATE('25/03/2024 11:30:00', 'DD/MM/YYYY HH24:MI:SS'), 'pat@oi.com');
...
(1, 1, 'Claudio Bispo', 'clau@oi.com', 'Tokito', TO_DATE('25/03/2024 11:30:00', 'DD/MM/YYYY HH24:MI:SS'));
