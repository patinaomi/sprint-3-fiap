...
export default function Footer(){
    return(
        ...
        <footer className="px-10 divide-y dark:bg-gray-700 dark:text-white bg-gray-200">
                ...
                <div className="lg:w-1/3 flex justify-start md:justify-center">
                    ...
                    <Link rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <div className="flex items-center justify-center rounded-full dark:bg-grey-700">
                           ...
                           <img src={"/assets/Footer/salesforce-logo.svg"} alt="Logo da SalesForce" width={150} height={200}/>
                ...
                <div className="flex flex-col justify-center md:grid gap-x-3 gap-y-8 lg:w-2/3 md:grid-cols-4">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <TextReader text="Contato">
                                    <Link rel="noopener noreferrer" href="/Contact">Contato</Link>
                                </TextReader>
                            </li>
                    ...
                    <div className="space-y-3 font-manrope text-lg">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <TextReader text="Nosso time">
                                    <Link rel="noopener noreferrer" href="/Team">Nosso time</Link>
                                </TextReader>
                            </li>

                            <li>
                                <TextReader text="Documentação acessibilidade">
                                    <Link rel="noopener noreferrer" href="/Documentation">Documentação acessibilidade</Link>
                                </TextReader>
                            </li>
                    ...
                    <TextReader text="Redes sociais">
                        ...
                        <div className="flex justify-start space-x-3">
                            ...
                            <Link rel="noopener noreferrer" href="https://www.facebook.com/salesforce/" title="Facebook" className="flex items-center p-1">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                                    <path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
                                </svg>
                            </Link>

                            <Link rel="noopener noreferrer" href="https://twitter.com/salesforce" title="Twitter" className="flex items-center p-1">
                            ...
                            <Link rel="noopener noreferrer" href="https://www.instagram.com/salesforce/" title="Instagram" className="flex items-center p-1">
            ...
            <TextReader text="2024 Tokito Techs. Todos os direitos reservados">
                <div className="py-6 text-manrope text-center dark:text-white">© 2024 Tokito Techs. Todos os direitos reservados.</div>
            </TextReader>
        </footer>
