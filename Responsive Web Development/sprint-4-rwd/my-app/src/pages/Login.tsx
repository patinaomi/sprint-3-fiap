...
export default function Login(){
    ...
    return(
        ...
        <div className="flex min-h-[100vh] bg-gray-100 dark:bg-gray-700 ">
            ...
            <div className="flex flex-col justify-center items-center gap-20 w-[60%] min-h-[100vh] p-10">

                <div>

                    <TextReader text="Buscamos simplicidade até no momento de fazer seu login">
                        <h1 className="text-5xl font-bold dark:text-white leading-20">Buscamos simplicidade até no momento de fazer seu login</h1>
                    </TextReader>

                </div>

                <div>
                    <Image src="/assets/Login/undraw_shopping_re_3wst.svg" alt="Imagem para página de login" width={500} height={200}></Image>
                </div>
            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <TextReader text="Esqueceu sua senha?">
...
{/* 
                        <button aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-[#3EA0E7]">
                            ...
                            <TextReader text="Acesse com GitHub">
                                <p className="dark:text-white font-bold">Acesse com GitHub</p>
                            </TextReader>

                        </button>

                        <button aria-label="Login with Twitter" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-[#3EA0E7]">
                            ...
                            <TextReader text="Acesse com Linkedin">
