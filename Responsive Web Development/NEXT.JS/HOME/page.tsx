...
import imagem1 from './banner-img.jpg'
import imagem2 from './logo2-removebg-preview.png'
    ...
    return (
        ...
        <div className="container-home-page">
            ...
            <div className='container-logos-tokito'>
                ...
                <div className="logo-banner-content-tokito">
                    <img className='logo-tokito' src={imagem2.src} alt="Logo da Tokito Techs" />
                </div> {/* Fim div logo-banner-content-tokito */}
