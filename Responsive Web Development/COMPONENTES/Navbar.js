        ...
        <header id="content-top">
            <div className="content-top--div max-container">
                <div className="nav-wrapper">
                    ...
                    /* NAV LOGO HOME */
                    <div claclassName="nav-wrapper--logo">
                        <a href="index.html" className="top-nav--logo">Sales<span>force</span></a>
                    </div> /* FIM DIV nav-wrapper--logo */

                    /* NAV LIST PAGES - OPCOES DO MENU */
                    ...
                    <div className="nav-util">
                        ...
                        <button className="Btn">
                            ...
                            </div> /* FIM DIV sign idioma */
                            <div className="text">
                                <a href="#">Idioma</a>
                            </div> /* FIM DIV text */
                        </button>

                        /* PARA ALTERAR O TEMA DA PÁGINA */

                        <button className="Btn">
                            <div className="sign mode">
                                <i className="fa-solid fa-moon" style="color: #ffffff;"></i>
                            </div> /* FIM DIV sign mode */
                    ...
                    </div> /* FIM DIV nav-util */
                </div> /* FIM DIV nav-wrapper*/
            </div> /* FIM DIV content-top--div max-container*/
        </header>
    )
}
