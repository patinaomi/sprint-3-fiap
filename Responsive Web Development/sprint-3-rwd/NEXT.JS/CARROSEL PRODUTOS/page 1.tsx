...
/* Precisa instalar o módulo swipper */
// npm install swiper
...
export default function CarroselProdutos() {
    ...
    return ( 
        <div className='container-clarrosel-produtos'>
            ...
            <div className='carrosel-itens-produto'>
                <Swiper             className='textos-carrosel-produtos'
                    slidesPerView={1}
                ...
                {imagens.map( (item) => (
                    <SwiperSlide className='box-itens-carrosel' key={item.id}>
                        <img src={item.imagem.src} alt="Foto da IA" className='slide-item' />
            ...
            <div className='box-textos-captar-pesquisa'>
                
                <div className='box-frase-feedback'>
                    <h1 className='titulo-descricao-feedback-carrosel'> Curtiu o nosso conteúdo? </h1>
                    <p className='descricao-feedback-carrosel'>Clica em AMEI, esse feedback vai nos ajudar a melhorar nossos conteúdos e serviços. </p>
                </div>
